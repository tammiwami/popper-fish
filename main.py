...
class Button:
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(surface, UI_BORDER_COLOR, self.rect, 2, border_radius=10)
        
        bubble_radius = 5
        pygame.draw.circle(surface, (255, 255, 255, 50), 
                          (self.rect.left + bubble_radius, self.rect.top + bubble_radius), 
                          bubble_radius)
...
def draw_game_over_screen(surface, score, play_button, exit_button):
    ...
    for i in range(0, game_over_text.get_width(), 2):
        ...
        subsurf_width = min(2, game_over_text.get_width() - i)   
        surface.blit(game_over_text.subsurface((i, 0, subsurf_width, game_over_text.get_height())), 
    ...
    surface.blit(bubble, (WIDTH//2 - bubble_size//2, HEIGHT//2 - bubble_size//2))
...
def main():
    while True:
        ...
        play_button = Button(WIDTH//2 - 150, HEIGHT//2 + 50, 120, 50, 
                           "Play Again", BUTTON_COLOR, BUTTON_HOVER_COLOR, BUTTON_TEXT_COLOR)
        exit_button = Button(WIDTH//2 + 30, HEIGHT//2 + 50, 120, 50, 
                           "Exit", BUTTON_COLOR, BUTTON_HOVER_COLOR, BUTTON_TEXT_COLOR)
        ...
        while waiting:
            ...
            WIN.fill((0, 0, 0))  
            draw_game_over_screen(WIN, 0, play_button, exit_button)  
            pygame.display.update()
